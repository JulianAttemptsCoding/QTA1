...
## [2026-07-10T16:54:22Z] P4/POLL
- Remaining P4 main shards are all still `JOB_STATE_RUNNING` on the new project.
- Output progress in the new bucket: FRSX `15,572`, TPET `16,852`, OGI `16,852`, CCO `16,212`, ICCM `16,596` rows.
- Counts were read while workers were writing and may include non-chunk boundary totals; no failures or preemptions observed.

## [2026-07-10T17:05:21Z] P4/POLL
- Remaining P4 main shards are all still `JOB_STATE_RUNNING` on the new project.
- Output progress in the new bucket: FRSX `15,956`, TPET `17,236`, OGI `17,236`, CCO `16,596`, ICCM `16,852` rows.
- Counts were read while workers were writing and may include non-chunk boundary totals; no failures or preemptions observed.

## [2026-07-10T17:06:21Z] P4/QA
- Parse QA over streamed current outputs remains `1.000000` valid for all five shards.
- Current QA totals: FRSX `15,956`, TPET `17,236`, OGI `17,236`, CCO `16,596`, ICCM `16,980` rows.

## [2026-07-10T17:17:22Z] P4/POLL
- Remaining P4 main shards are all still `JOB_STATE_RUNNING` on the new project.
- Output progress in the new bucket: FRSX `16,340`, TPET `17,620`, OGI `17,620`, CCO `16,980`, ICCM `17,236` rows.
- Counts were read while workers were writing and may include non-chunk boundary totals; no failures or preemptions observed.

## [2026-07-10T17:28:23Z] P4/POLL
- Remaining P4 main shards are all still `JOB_STATE_RUNNING` on the new project.
- Output progress in the new bucket: FRSX `16,596`, TPET `18,004`, OGI `18,004`, CCO `17,364`, ICCM `17,620` rows.
- Counts were read while workers were writing and may include non-chunk boundary totals; no failures or preemptions observed.

## [2026-07-10T17:39:17Z] P4/POLL
- Remaining P4 main shards are all still `JOB_STATE_RUNNING` on the new project.
- Output progress in the new bucket: FRSX `16,980`, TPET `18,388`, OGI `18,388`, CCO `17,748`, ICCM `18,004` rows.
- Counts were read while workers were writing and may include non-chunk boundary totals; no failures or preemptions observed.

## [2026-07-10T17:50:19Z] P4/POLL
- Remaining P4 main shards are all still `JOB_STATE_RUNNING` on the new project.
- Output progress in the new bucket: FRSX `17,364`, TPET `18,772`, OGI `18,772`, CCO `18,004`, ICCM `18,388` rows.
- Counts were read while workers were writing and may include non-chunk boundary totals; no failures or preemptions observed.

## [2026-07-10T18:01:21Z] P4/POLL
- Remaining P4 main shards are all still `JOB_STATE_RUNNING` on the new project.
- Output progress in the new bucket: FRSX `17,748`, TPET `19,156`, OGI `19,156`, CCO `18,388`, ICCM `18,644` rows.
- Counts were read while workers were writing and may include non-chunk boundary totals; no failures or preemptions observed.

## [2026-07-10T18:12:13Z] P4/POLL
- Remaining P4 main shards are all still `JOB_STATE_RUNNING` on the new project.
...
## [2026-07-10T19:04:55Z] P4/POLL
- Remaining P4 main shards are all still `JOB_STATE_RUNNING` on the new project.
- Output progress in the new bucket: FRSX `19,156`, TPET `20,948`, OGI `20,692`, CCO `20,436`, ICCM `20,180` rows.
- Counts were read while workers were writing and may include non-chunk boundary totals; no failures observed.

## [2026-07-10T19:15:46Z] P4/POLL
- Remaining P4 main shards are all still `JOB_STATE_RUNNING` on the new project.
- Output progress in the new bucket: FRSX `19,540`, TPET `21,332`, OGI `21,076`, CCO `20,820`, ICCM `20,564` rows.
- Counts were read while workers were writing and may include non-chunk boundary totals; no failures observed.

## [2026-07-10T19:26:40Z] P4/POLL
- Remaining P4 main shards are all still `JOB_STATE_RUNNING` on the new project.
...
## [2026-07-10T20:00:03Z] P4/POLL
- Remaining P4 main shards are all still `JOB_STATE_RUNNING` on the new project.
- Output progress in the new bucket: FRSX `20,820`, TPET `22,740`, OGI `22,612`, CCO `22,228`, ICCM `21,844` rows.
- Counts were read while workers were writing and may include non-chunk boundary totals; no failures observed.

## [2026-07-10T20:10:55Z] P4/POLL
- Remaining P4 main shards are all still `JOB_STATE_RUNNING` on the new project.
...
## [2026-07-10T21:31:12Z] P4/POLL
- CCO original spot job reached `JOB_STATE_SUCCEEDED` with `25,000` outputs.
- Remaining active jobs: FRSX original spot `JOB_STATE_RUNNING`, TPET/OGI/ICCM on-demand resumes `JOB_STATE_RUNNING`.
- Output progress in the new bucket: FRSX `23,764`, TPET `24,788`, OGI `24,148`, ICCM `23,380` rows.

## [2026-07-10T21:37:08Z] P4/POLL
- TPET on-demand resume job reached `JOB_STATE_SUCCEEDED` with `25,000` outputs.
- CCO remains complete; remaining active jobs are FRSX original spot plus OGI/ICCM on-demand resumes.
- Output progress in the new bucket: FRSX `24,020`, OGI `24,276`, ICCM `23,508` rows.

## [2026-07-10T21:43:06Z] P4/POLL
...
- Output progress in the new bucket: FRSX `24,276`, OGI `24,532`, ICCM `23,764` rows.

## [2026-07-10T21:49:02Z] P4/POLL
- TPET and CCO remain complete.
- Remaining active jobs are still `JOB_STATE_RUNNING`: FRSX original spot plus OGI/ICCM on-demand resumes.
...
## [2026-07-10T22:00:52Z] P4/POLL
- OGI on-demand resume job reached `JOB_STATE_SUCCEEDED` with `25,000` outputs.
- TPET and CCO remain complete; remaining active jobs are FRSX original spot and ICCM on-demand resume.
- Output progress in the new bucket: FRSX `24,788`, ICCM `24,404` rows.

## [2026-07-10T22:06:46Z] P4/POLL
...
## [2026-07-10T23:12:10Z] P4/A-402-A-403-POLL
- Same five NVNI follow-up jobs remain `JOB_STATE_RUNNING`; the other seven jobs remain `JOB_STATE_PENDING` for on-demand T4 allocation.
- Output progress: NVNI scaling N50 `1,280`, N100 `1,408`, N300 `1,664`, N1000 `1,792`, news-off `1,536`; pending jobs still have no outputs.

## [2026-07-10T23:24:03Z] P4/A-402-A-403-QA
...
## [2026-07-11T00:31:39Z] P4/A-402-A-403-POLL
- NVNI N100/N300/N1000/news-off/personas-off remain `JOB_STATE_RUNNING`; N50 v2 and all TLRY follow-ups remain `JOB_STATE_PENDING`.
- Output progress: NVNI scaling N50 v2 `0`, N100 `4,280`, N300 `4,608`, N1000 `5,248`, news-off `4,792`, personas-off `1,408`.

## [2026-07-11T00:42:55Z] P4/A-402-A-403-POLL
- NVNI N100/N300/N1000/news-off/personas-off remain `JOB_STATE_RUNNING`; N50 v2 and all TLRY follow-ups remain `JOB_STATE_PENDING`.
- Output progress: NVNI scaling N50 v2 `0`, N100 `4,664`, N300 `4,864`, N1000 `5,632`, news-off `5,176`, personas-off `1,664`.

## [2026-07-11T00:54:10Z] P4/A-402-A-403-POLL
- NVNI N100/N300/N1000/news-off/personas-off remain `JOB_STATE_RUNNING`; N50 v2 and all TLRY follow-ups remain `JOB_STATE_PENDING`.
- Output progress: NVNI scaling N50 v2 `0`, N100 `5,048`, N300 `5,248`, N1000 `6,016`, news-off `5,560`, personas-off `2,048`.
...
## [2026-07-11T04:12:43Z] P4/A-402-TLRY-N100-COMPLETE
- TLRY scaling N100 reached `JOB_STATE_SUCCEEDED` at `2026-07-11T04:12:07Z` with `6,000` outputs.
- Synced artifacts locally and accepted the shard: `6,000/6,000` requests/outputs, `60` sim rows, fixed-parser rate `0.999000` (`5,994/6,000`), worker summary `valid_json_rate=0.992667`.
- Removed TLRY N100 from `STATE.json` active jobs and actualized its budget row; conservative cumulative budget is now `$73.69`.

## [2026-07-11T04:46:45Z] P4/A-403-TLRY-NEWS-OFF-COMPLETE
